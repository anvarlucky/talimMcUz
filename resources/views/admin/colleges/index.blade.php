    ...
    <div class="container-fluid p-5">
        <div class="col-12 px-0 table-box">
            <div class="table-top-panel d-flex align-items-center justify-content-between px-2 py-3">
                <ul class="d-flex">
                    <li class="col px-0 mx-3 table-top-panel-items {{route('colleges.index') ? 'active' : ''}}">
                        <a href="{{route('colleges.index')}}" class="text-decoration-none table-top-panel-items-link">Коллежлар</a>
                    </li>
                </ul>


                <a href="{{route('colleges.create')}}" type="button" class="btn adding-button">
            ...
            <div class="table-responsive">
                <table class="table table-hover">
                    ...
                    <tr>
                        ...
                        <th class="darkblue-color">Дректор номи</th>
                    ...
                    <tr>
                        ...
                        @if(Auth::user()->role=='Direktor')
                            <td class="darkblue-color"><a href="{{route('colleges.show', $college->id)}}">{{$college->name}}</a></td>
                        @else
                        ...
                        @if($college->director_id != null)
                        <td class="darkblue-color">{{$college->director->name}}</td>
                        @else
                        <td class="darkblue-color">-</td>
                        @endif
