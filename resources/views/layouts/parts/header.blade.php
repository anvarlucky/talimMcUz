<header id="header" class="header">
    <div class="top-left">
        <div class="navbar-header">
            <a class="navbar-brand" href="/admin">Админ панели</a>
        ...
        <div class="header-menu">
            ...
            <div class="user-area dropdown float-right">
                ...
                <div class="user-menu dropdown-menu">
                    <a class="nav-link" href="#"><i class="fa fa- user"></i>Менинг профилим</a>

                    <a class="nav-link" href="#"><i class="fa fa- user"></i>Хабарномалар <span class="count">13</span></a>

                    <a class="nav-link" href="#"><i class="fa fa -cog"></i>Созламалар</a>

                    <a class="nav-link" href="{{route('logout')}}"><i class="fa fa-power -off"></i>Чиқиш</a>
                </div>
            </div>
